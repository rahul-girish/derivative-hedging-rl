...
print(f"Initial Option Premium : {result.option_values[0]:.4f}")
print(f"Final Option Value     : {result.option_values[-1]:.4f}")
print(f"Final Hedge Value      : {result.portfolio_values[-1]:.4f}")